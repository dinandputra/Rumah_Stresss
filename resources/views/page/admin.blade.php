    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        @elsecan('isManager')
          ...
          <div class="info">
            <a href="http://127.0.0.1:8000/home" class="d-block">David Martines</a>
          </div>
        @else
        <div class="image">
        ...
        <div class="info">
          <a href="http://127.0.0.1:8000/home" class="d-block">Markus Aligate</a>
        </div>
        @endcan 
        </div>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              @can('isAdmin')
                ...
                @elsecan('isManager')
                  <div >
                    <h3>Dashboard <button type="button" onclick="location.href='http://127.0.0.1:8000/login';" class="btn btn-primary btn-lg"> Manager </button>
                  </div>
                @else
                  <div >
                    <h3>Dashboard <button type="button" onclick="location.href='http://127.0.0.1:8000/login';" class="btn btn-info btn-lg"> User </button>
                  </div>
                @endcan   
          </div><!-- /.col -->
          <div class="col-sm-6">
